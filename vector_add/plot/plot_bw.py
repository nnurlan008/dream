...
if __name__=="__main__":
	# Open file  
    with open('/home/nurlan/Desktop/02_read-write/vector_add/plot/1_qp_bw.csv') as file_obj:
        ...
        #           '64KB', '128KB', '160KB', '256KB', '512KB']

        x_axis = ['4B', '8B', '16B', '32B', '64B', '128B', '256B', '512B', '1KB', '2KB', '4KB', '8KB', '16KB', '32KB',\
                  '64KB', '128KB', '256KB', '512KB', '1MB', '2MB', '4MB', '8MB', '16MB']

        my_list = [ float(i) for i in list(reader_obj[1][1:])]
        y_axis = my_list
        ...
        plt.ylim(0, max(y_axis)+0.5)
        plt.title("BW vs Data Size with 1 QPs")
        plt.ylabel("BW [GBps]")
        plt.xlabel("Data [bytes]")
        plt.grid(which='major', color='#DDDDDD', linewidth=0.8)
        plt.grid(which='minor', color='#EEEEEE', linestyle=':', linewidth=0.5)
        plt.text(0.2, 3.55, 'peak 16MB: 3.214732 GBps', fontsize = 11)
        # plt.legend("peak 512KB: 3.331780 GBps" )
        # plt.minorticks_on()
